...
<body>
    <form id="form2" runat="server">
        <div>
            ...
            <asp:GridView ID="gridSalarios" runat="server" AutoGenerateColumns="True" PageSize="300" onPageIndexCharging="gridSalarios_MudarPagina"></asp:GridView>
            ...
            <asp:Button ID="btnVoltarPagina" runat="server" Text="Voltar Página ➡️" OnClick="btnVoltarPagina_Click" />
